 ...
 */
class Apian2Projection : PseudoCylindricalProjection() {

    companion object {
        private const val HLFPI2 = 2.46740110027233965467
        private const val RHALFPI = 0.6366197723675813430755350534
    }

    override fun project(lplam: Double, lpphi: Double, out: Point2D.Double): Point2D.Double {
        out.y = lpphi
        out.x = lplam * RHALFPI * sqrt(abs(HLFPI2 - lpphi * lpphi))
        return out
    }
    ...
    override fun toString(): String = "Apian Globular II"
}
