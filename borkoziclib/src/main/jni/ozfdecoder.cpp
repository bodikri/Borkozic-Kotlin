...
extern "C" {
    JNIEXPORT jlong JNICALL Java_com_borkozic_map_OzfDecoder_openImageNative(JNIEnv* env, jclass clazz, jstring path);
    JNIEXPORT void JNICALL Java_com_borkozic_map_OzfDecoder_closeImageNative(JNIEnv* env, jclass clazz, jlong fileptr);
    JNIEXPORT jintArray JNICALL Java_com_borkozic_map_OzfDecoder_getTileNative(JNIEnv* env, jclass clazz, jlong fileptr, jint type, jint key, jint depth, jint offset, jint i, jint w, jint h, jbyteArray p);
};
...
jlong Java_com_borkozic_map_OzfDecoder_openImageNative(JNIEnv* env, jclass clazz, jstring path)
{
...
void Java_com_borkozic_map_OzfDecoder_closeImageNative(JNIEnv* env, jclass clazz, jlong fileptr)
{
...
jintArray Java_com_borkozic_map_OzfDecoder_getTileNative(JNIEnv* env, jclass clazz, jlong fileptr, jint type, jint key, jint depth, jint offset, jint i, jint w, jint h, jbyteArray p)
{
