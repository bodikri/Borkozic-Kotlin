...
class MapActivity : AppCompatActivity(), View.OnClickListener, OnSharedPreferenceChangeListener,
    ...
    override fun onResume() {
        ...
        try {
            val def_plane = (application!!.planePath!!).substring(36)
    ...
    override fun onSharedPreferenceChanged(sharedPreferences: SharedPreferences, key: String?) {
        ...
        } else if (getString(R.string.pref_folder_plane) == key) {
            application!!.setDataPath(
                Borkozic.PATH_PLANES,
                sharedPreferences.getString(key, resources.getString(R.string.def_folder_plane))!!
            )
            map!!.planeLogo = (application!!.planePath!!).substring(36)
            map!!.setMovingCursorSize(
